...
struct Intersection {
    array<int, 10> north{INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX};
    array<int, 10> east{INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX};
    array<int, 10> south{INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX};
    array<int, 10> west{INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX, INT32_MAX};
};
...
std::string run(FileReader& reader) {
    ...
    while (!crucibles.empty())
    {
        ...
        if(crucible.direction == 's') {
            ...
            if(crucible.steps<10 && crucible.y<height-1) {
        ...
        if(crucible.direction == 'n') {
            if(crucible.steps<10 && crucible.y>0) {
        ...
        if(crucible.direction == 'e') {
            ...
            if(crucible.steps<10 && crucible.x<width-1) {
        ...
        if(crucible.direction == 'w') {
            if(crucible.steps<10 && crucible.x>0) {
